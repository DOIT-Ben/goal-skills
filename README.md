...
- Product / Idea To Shipped Product：从产品 idea 到可落地切片
...
如果输入是产品 idea，`goal-skills` 会生成从 idea 到落地的目标，并推荐后续使用 [products-skills](https://github.com/DOIT-Ben/products-skills) 做产品澄清、判断、计划、QA 和发布交接。
